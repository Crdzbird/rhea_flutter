...
class _EndingWorkoutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<EndWorkoutBloc, EndWorkoutState>(
      listener: (context, state) {
        if (state is OnFailedEndWorkout) {
        ...
        if (state is OnSuccessEndWorkout) {
          routemasterDelegate.pop();
        }
      },
      child: Scaffold(
        body: Column(
            ...
            AnimatedSwitcher(
              ...
              child: context.watch<EndingWorkoutCubit>().state.isNotEmpty
                  ? SolidButton(
                      ...
                      onPressed: () =>
                          context.read<EndWorkoutBloc>().endWorkout(
                                stageId,
                                toReasonTypeEnum(
