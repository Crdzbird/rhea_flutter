// ignore_for_file: prefer_null_aware_method_calls, library_private_types_in_public_api, lines_longer_than_80_chars
...
class CupertinoInkWell extends StatefulWidget {
  ...
  bool debugCheckContext(BuildContext context) {
    assert(
      ...
      'No Directionality widget found in the context.\n'
      'CupertinoInkWell widgets require Directionality to be '
      'installed. Please add a Directionality widget to your app.',
    );
    return true;
  }
...
class _CupertinoInkWellState extends State<CupertinoInkWell> {
  ...
  Widget build(BuildContext context) {
    assert(
      ...
      'InkWell widgets must be placed inside a Material widget that '
      'either directly or indirectly contains a MaterialTheme widget.',
    );
    return Actions(
      actions: _actionMap,
      child: Focus(
